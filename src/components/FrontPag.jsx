...
import Modal from './NewUser';
import React, { useState, useEffect } from 'react';
import BookPen from '../assets/BookPen.png';
// import {AllNotes} from './AllNotes';
import AllNotes from './AllNotes';
// import FrontPage from './components/FrontPag';
    ...
    <>
      {screenSize.width < 989 ? (
        <div className="sidebarContainerMobile">
          {groupSelect ? (
            ...
            <>
              ...
              <img src={add} className="CreateButton" onClick={() => setOpenModal(true)}>
        ...
        <>
          ...
          <div className={groupSelect ? "MessageAreaContainerr" : "MessageAreaContainer"} >
            {groupSelect ? (
              <AllNotes
                groupSelect={groupSelect}
                groups={groups}
              ...
              <>
                <div className="MessageAreaText">
                  <img src={BookPen} alt="BookPen"></img>
